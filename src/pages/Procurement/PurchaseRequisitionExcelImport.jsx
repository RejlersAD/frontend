...
const PurchaseRequisitionExcelImport = ({ isOpen, onClose, onImported, onAttachPdf, canLinkPurchaseOrder = true, canUploadPurchaseOrder = false }) => {
...
PurchaseRequisitionExcelImport.propTypes = {
