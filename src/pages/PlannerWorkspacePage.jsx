        ...
        <section className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
          <div role="navigation" aria-label="Planning workspace areas" className="border-b border-slate-200 flex flex-wrap items-center gap-1 px-3 pt-2">
            ...
            <div className="ml-auto flex items-center gap-2 pb-2">
              ...
              <button title={approvalBlocked ? 'Complete and approve Phase 3 assurance before schedule approval.' : 'Approve this calculated version'} onClick={() => runAction('approve', () => planningIntelligenceService.approveScheduleVersion(versionId), 'Schedule version approved.')} disabled={Boolean(busy) || workspace?.version?.status !== 'calculated' || workspace?.version?.can_approve !== true || approvalBlocked} className="px-3 py-2 rounded-lg bg-emerald-600 text-white text-sm font-semibold disabled:opacity-40">Approve</button>
