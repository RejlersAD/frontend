...
const DesignIQLists = () => {
  ...
  const [lineNumberFormat, setLineNumberFormat] = useState({
    ...
    allowVariableSeparators: true  // Allow -, â€“, â€”, etc.
  ...
  const pollTaskStatus = async (taskId) => {
    ...
    const poll = async () => {
      ...
      try {
        ...
        console.log(`ðŸ“Š Poll ${attempts}/${maxAttempts}: ${status.state} - ${status.status}`);
        ...
        if (status.state === 'SUCCESS' && status.result) {
          ...
          setProcessingProgress({ step: 'âœ… Complete!', percent: 100 });
  ...
  const processAllDocuments = async () => {
    ...
    setTimeout(() => setProcessingProgress({ step: 'ðŸ“¤ Uploading P&ID + HMB + PMS + NACE...', percent: 10 }), 2000);

    setTimeout(() => setProcessingProgress({ step: 'ðŸ“„ Running OCR on P&ID drawing...', percent: 30 }), 8000);

    setTimeout(() => setProcessingProgress({ step: 'ðŸ” Extracting 8 base columns...', percent: 50 }), 15000);

    setTimeout(() => setProcessingProgress({ step: 'ðŸ“Š Analyzing HMB (process data)...', percent: 65 }), 25000);

    setTimeout(() => setProcessingProgress({ step: 'ðŸ”§ Analyzing PMS (materials)...', percent: 75 }), 35000);

    setTimeout(() => setProcessingProgress({ step: 'âš—ï¸ Analyzing NACE (corrosion)...', percent: 85 }), 45000);

    setTimeout(() => setProcessingProgress({ step: 'ðŸ¤– AI enrichment (+26 columns)...', percent: 93 }), 60000);

    setTimeout(() => setProcessingProgress({ step: 'âœ¨ Finalizing 34-column table...', percent: 97 }), 75000);
    ...
    try {
      ...
      // onshore â†’ format_type='onshore', include_area=false
      ...
      // general â†’ format_type='general', include_area=true  
      ...
      // offshore â†’ format_type='offshore', include_area=true
      ...
      if (response.ok) {
        ...
        if (data.task_id && !data.enriched_data && !data.extracted_lines) {
          ...
          console.log(`ðŸ”„ Async mode: Task ${data.task_id} queued, starting polling...`);

          setProcessingProgress({ step: 'â³ Processing in background...', percent: 50 });
        ...
        if (data.enriched_data && data.enriched_data.length > 0) {
          ...
          console.log(`âœ“ ENRICHED: ${data.enriched_data.length} lines with 34 columns`);
          ...
          console.log(`âœ“ BASE: ${data.extracted_lines.length} lines with 8 columns`);
  ...
  const handlePIDUpload = async (event, includeArea = false, formatType = 'onshore') => {
    ...
    try {
      ...
      console.log('[P&ID Upload] ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€¦Ã‚Â¡ÃƒÂ¢Ã¢â‚¬Å¡Â¬ Starting upload with extended timeout (10 minutes)...');
      ...
      const response = await apiClientLongTimeout.post(
...

        {
          ...
          onUploadProgress: (progressEvent) => {
            ...
            console.log('[P&ID Upload] ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒâ€¦Â  Upload progress:', percentCompleted + '%');
      ...
      console.log('[P&ID Upload] ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã¢â‚¬Å“ÃƒÂ¢Ã¢â€šÂ¬Â¦ Processing complete');
      ...
      console.error('[P&ID Upload] ÃƒÆ’Ã‚Â¢Ãƒâ€šÃ‚ÂÃƒâ€¦Ã¢â‚¬â„¢ Error:', error);
          ...
          <div className="w-full bg-gradient-to-r from-indigo-50 via-purple-50 to-pink-50 border-2 border-indigo-300 rounded-xl p-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-1">
                ...
                <h3 className="text-lg font-bold text-indigo-900 mb-1">ðŸ“„ P&ID Processing Interface</h3>
            ...
            <div className="mt-4 p-4 bg-gradient-to-r from-gray-50 to-blue-50 border-2 border-gray-300 rounded-lg">
              ...
              {(!pidDocument || !hmbDocument || !pmsDocument || !naceDocument || !stressCriticalityDocument) && (
                ...
                <div className="mt-3 text-center text-sm text-yellow-700 font-medium">
                  ...
                  âš ï¸ Upload all 5 documents to enable processing with 35-column enrichment
              ...
              <div className="ml-4 flex-1">
                ...
                {uploadResult.success && uploadResult.data?.extracted_lines && (
                  ...
                  <div className="mt-3 text-xs text-green-600 font-medium">
                    ...
                    <p>ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã¢â‚¬Å“ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ OCR processing completed</p>

                    <p>ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã¢â‚¬Å“ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ {uploadResult.data.extracted_lines.length} line numbers detected</p>
          ...
          <div className="bg-white rounded-2xl p-8 max-w-md shadow-2xl">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm text-gray-500 mt-4 text-center">
                ...
                ÃƒÆ’Ã‚Â¢Ãƒâ€šÂÃƒâ€šÃ‚Â±ÃƒÆ’Ã‚Â¯Ãƒâ€šÃ‚Â¸Ãƒâ€šÂ <strong>Processing time:</strong> 2-10 minutes for complex PDFs
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full p-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6">
                ...
                P&ID + HMB + PMS + NACE â†’ 34-column enriched table
              ...
              <div className="mt-6 p-4 bg-purple-50 border border-purple-200 rounded-lg text-left">
                ...
                <ul className="text-sm text-purple-800 space-y-1">
                  ...
                  <li>â€¢ <strong>Step 1:</strong> Extract 8 base columns from P&ID (locked logic)</li>

                  <li>â€¢ <strong>Step 2:</strong> AI analyzes 3 documents for +26 enrichment columns</li>

                  <li>â€¢ <strong>Step 3:</strong> Merge into guaranteed 34-column table</li>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <h3 className="text-lg font-bold text-indigo-900">ðŸ“‚ Previous Outputs</h3>
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col">
            ...
            <div className="flex-1 overflow-auto p-6 space-y-6">
              ...
              <div className="bg-gradient-to-br from-indigo-50 to-purple-50 border-2 border-indigo-200 rounded-xl p-4">
                ...
                <h3 className="text-sm font-semibold text-gray-700 mb-2">ðŸ“‹ Current Format Template</h3>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-4">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <label className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-gray-700">Allow variable separators (-, â€“, â€”, etc.)</span>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-4">
                ...
                <h3 className="text-sm font-semibold text-gray-700 mb-4">âš™ï¸ Line Number Components</h3>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-4">
                ...
                <h3 className="text-sm font-semibold text-gray-700 mb-3">ðŸŽ¯ Common Configurations</h3>
