...
function PortfolioDecisions({ report, portfolio, onExplain, printing }) {
  ...
  return <section className="pp-panel pp-decisions" aria-labelledby="pp-decisions-title" data-testid="portfolio-decisions">
    ...
    {visible.length ? <div className="cc-table-wrap"><table className="cc-table pp-decisions-table"><caption className="cc-sr-only">Portfolio interventions, source context, owners and due dates</caption><thead><tr>
