...
export default function PortfolioRevenueOverview({ data, onNavigate, onExplain, searchText, onSearch, businessUnit, businessUnits, onBusinessUnit }) {
