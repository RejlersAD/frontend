...
export function DecisionsRequired({ report, printing = false, onExplain }) {
  ...
  return <section className="cc-panel cc-decisions" aria-labelledby="decisions-title" data-testid="executive-decisions">
    ...
    {visible.length ? <div className="cc-table-wrap"><table className="cc-table cc-decisions-table"><caption className="cc-sr-only">Management decisions and accountable owners</caption><colgroup><col className="cc-col-priority" /><col className="cc-col-decision" /><col className="cc-col-detail" /><col className="cc-col-impact" /><col className="cc-col-owner" /><col className="cc-col-due" /><col className="cc-col-action" /></colgroup><thead><tr><th scope="col">Priority</th><th scope="col">Decision</th><th scope="col">Detail</th><th scope="col">Value / Impact</th><th scope="col">Owner</th><th scope="col">Due date</th><th scope="col">Action</th></tr></thead><tbody>
